...
a=addmf(a, 'input', 1, 'medium', 'gaussmf',[8.493 50]);
a=addmf(a, 'input', 1, 'high', 'gaussmf',[15 100])

a=addvar(a, 'input', 'Objectivity(%)', [0 100]);
a=addmf(a, 'input', 2, 'weak', 'gaussmf',[20 1]);
a=addmf(a, 'input', 2, 'medium', 'gaussmf',[15 50]);
a=addmf(a, 'input', 2, 'strong', 'gaussmf',[10 100]);
