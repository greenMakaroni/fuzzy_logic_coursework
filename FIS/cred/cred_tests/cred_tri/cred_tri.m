...
a=addmf(a, 'input', 1, 'low', 'trimf',[0 0 5]);
a=addmf(a, 'input', 1, 'medium', 'trimf',[4 5 6]);
a=addmf(a, 'input', 1, 'high', 'trimf',[5 10 10]);
...
for i=1:5
    ...
    for j=1:size(DummyData,1)
            ...
            xlswrite('cred_tri_output.xlsx', eval_information_credibility, 1, sprintf(xls_output_cols(i), j+1));
            fprintf( ...
